...
const RepositoryItem = ({ full_name, description, open_issues_count, stargazers_count, id }: RepositoryItemProps) => {
    ...
    const handleGetIssueList = useCallback(async () => {
        ...
        navigate("/issues");
    }, [full_name, navigate, open_issues_count, setIssues]);
    ...
    return (
        ...
        >
            <Box display="flex" flexDirection={"column"} height={"100%"} justifyContent={"space-between"} padding="3">
                <Box>
                    <Box mt="1" display={"flex"} alignItems={"center"} fontWeight="semibold" as="h4" lineHeight="tight">
